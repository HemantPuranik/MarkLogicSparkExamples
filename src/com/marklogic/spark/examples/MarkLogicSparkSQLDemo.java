...
public class MarkLogicSparkSQLDemo {
    private static final Function<Tuple2<DocumentURI, MarkLogicNode>, ConsumerComplaint> CONSUMER_COMPLAINT_EXTRACTOR =
            new Function<Tuple2<DocumentURI, MarkLogicNode>, ConsumerComplaint>() {
                @Override
                public ConsumerComplaint call(Tuple2<DocumentURI, MarkLogicNode> arg) throws Exception {
    ...
    public static void main(String[] args) {
        ...
        JavaRDD<ConsumerComplaint> consumerComplaints = mlRDD.map(CONSUMER_COMPLAINT_EXTRACTOR);
        SQLContext sqlContext = new SQLContext(context);
        sqlContext.setConf("spark.sql.shuffle.partitions", String.valueOf(10));
        DataFrame sqlRDD = sqlContext.applySchema(consumerComplaints, ConsumerComplaint.class);
        sqlRDD.registerTempTable("ConsumerComplaints");
